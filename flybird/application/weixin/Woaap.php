...
class Woaap extends Birdcore
{
    ...
    public function getWoaAcKey(){
        ...
        \app\addon\Applog::appLog('logs',['getackey' => $ret,'apiurl' => $uri,'file' => __FILE__,'line' => __LINE__]);
    ...
    public function getWoaapAccessToken()
    {
        ...
        BIRD_APP_DEBUG && \app\addon\Applog::appLog('logs',['getwoa_access_token' => $ret,'apiurl' => $url,
